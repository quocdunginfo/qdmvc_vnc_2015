...
function generalToolbar()
{
    ...
    <div style="margin-bottom: 5px">
        ...
        <span>
                <button class="btn btn-primary btn-xs qd-action-btn" id="qdselectionmode" style="<?=$this->data['role'] == 'lookup'?'display: none':''?>" type="button" >
                    <?= Qdmvc_Message::getMsg('btn_multiselection') ?>
                </button>
            </span>
        <span>
                <button class="btn btn-primary btn-xs qd-action-btn" id="qdselectallrows" type="button" style="display: none">
