...
class Qdmvc_Layout_List extends Qdmvc_Layout_Root
{
    ...
    function internalGateway()
    {
        ...
        <?= $this->qrCodeScript() ?>
        <!-- Modal -->
        <div class="modal fade" id="qdQRModal" tabindex="-1" role="dialog" aria-labelledby="myQRModalLabel">
        ...
        <!-- Import $("#qdMsgModal").modal('show'); -->
        <div class="modal fade" id="qdImportModal" tabindex="-1" role="dialog" aria-labelledby="myImportLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            ...
            (function($, window, document, undefined) {
                ...
                var Self, display, videoSelect, lastImageSrc, con, beepSound, w, h, lastCode,
                    ...
                    defaults = {
                        ...
                        zoom: -1,
                        beep: 'audio/beep.mp3',
                        decoderWorker: new Worker('<?=QdJqwidgets::getResourcePath('plugin/qr/DecoderWorker.js')?>'),
                        brightness: 0,
