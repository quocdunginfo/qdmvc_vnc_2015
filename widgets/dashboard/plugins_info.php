...
add_action('wp_dashboard_setup', array('QdmvcNativeWidget_Plugins_Info','init') );

class QdmvcNativeWidget_Plugins_Info
{

    /**
     * The id of this widget.
     */
    const wid = 'qdmvcnativewidget_plugins_info';
    ...
    public static function init()
    {
        ...
        wp_add_dashboard_widget(
            ...
            __('QD PLUGINS INFO', 'nouveau'),//Visible name for the widget
            array('QdmvcNativeWidget_Plugins_Info', 'widget'),      //Callback for the main widget content
            array('QdmvcNativeWidget_Plugins_Info', 'config')       //Optional callback for widget configuration content
        );
    }
